...
const versionesQ3 = [
  {
    id: 'q3',
    name: 'Q3',
    image: '/Vehiculos/Q3.webp',
    description: 'SUV compacta premium con máxima versatilidad',
    motor: '1.5 TFSI',
    potencia: '150 CV',
    link: '/modelos/Q3/q3-35-tfsi'
  },
  {
    id: 'q3-s-line',
    name: 'Q3 Sportback',
    image: '/Vehiculos/Q3-sline.webp',
    description: 'Deportividad y estilo con acabado S line',
    motor: '1.5 TFSI',
    potencia: '150 CV',
    link: '/modelos/Q3/q3-35-tfsi-s-line'
  },
  {
    id: 'q3-sportback',
    name: 'RS Q3 Sportback',
    image: '/Vehiculos/Q3-sportback.webp',
    description: 'Diseño coupé deportivo en formato SUV',
    motor: '1.5 TFSI',
    potencia: '150 CV',
    link: '/modelos/Q3/q3-sportback-35-tfsi-s-line'
  },
];

export default function Q3IndexPage() {
  return (
    <div className="min-h-screen bg-[#0a0d11] text-white">
      <div className="max-w-screen-2xl mx-auto px-6 py-12">
        ...
        <div className="mb-12 mt-16">
          ...
          <h1 className="text-5xl md:text-6xl font-light mb-4 tracking-tight">Audi Q3</h1>
        ...
        <div className="mb-10">
          <p className="text-3xl md:text-4xl font-light">
            <span className="text-white">{versionesQ3.length}</span>
